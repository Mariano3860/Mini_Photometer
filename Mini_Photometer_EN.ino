...
String menu[] = {
  "Menu",                                          //0
  "Menu>Quick Analysis",                           //1
  "Menu>Manual",                                   //2
  "Menu>Manual>Perform Analysis",                  //3
  "Menu>Manual>Light Setting",                     //4
  "Menu>Manual>Light Setting>RGB",                 //5  
  "Menu>Manual>Light Setting>UV",                  //6
  "Menu>Manual>Light Setting>White",               //7
  "Menu>Manual>Sensors Config.",                   //8
  "Menu>Manual>Sensors Config.>Color",             //9
  "Menu>Manual>Sensors Config.>Return",            //10
  "Menu>Manual>Sensors Config.>Color>On*",         //11
  "Menu>Manual>Sensors Config.>Color>Delay",       //12  
  "Menu>Manual>Sensors Config.>Color>Repetitions", //13  
  "Menu>Manual>Sensors Config.>Lux",               //14
  "Menu>Manual>Sensors Config.>Lux>Delay",         //15
  "Menu>Manual>Sensors Config.>Lux>On*",           //16
  "Menu>Manual>Sensors Config.>Lux>Repetitions",   //17
  "Menu>Manual>Comparative",                       //18
  "Menu>Complete RGB",                             //19
};
  ...
  while (possiblePosCount == 0) {
    ...
    if (possiblePosCount == 0) {
      ...
      switch (currentPos) {
        case 1:
          lcd.clear();
          Serial.print("Quick Analysis: ");
          lcd.setCursor(0,0); lcd.print("Quick Analysis");
          lcd.setCursor(0,1); lcd.print("Analysing..."); 
              C_delay = 20;
              C_times = 100;
              L_delay = 100;
              L_times = 5;
          ...
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Avg.: "); lcd.print(L_Prom); lcd.print(" lx");
          lcd.setCursor(0,1); lcd.print("N:"); lcd.print(N_Prom); lcd.print(" R:"); lcd.print(R_Prom);
             ...
             for (byte i = 0; i < 2; i++)
             {
              ...
              int but2 = digitalRead(buttons[2]);           
               ...
               //Hold until you lift the button
               while (but1 != 0) {
                but1 = 0;
        ...
        case 3:
          lcd.clear();
          Serial.println("Manual Analysis");
          lcd.setCursor(0,0); lcd.print("Manual Analysis");
          delay (800);
          Comp_t = 0;

          if (Comp_on == 1) {
            lcd.clear();
            lcd.setCursor(0,0); lcd.print("Put Pattern");       
            lcd.setCursor(0,1); lcd.print("Press 2nd Btn");
                  for (byte i = 0; i < 2; i++)
                 {
                  int but0 = digitalRead(buttons[0]);
                  int but1 = digitalRead(buttons[1]);
                  int but2 = digitalRead(buttons[2]);  
                     ...
                     if (but1 != 0) {
                      lcd.clear();
                      lcd.setCursor(0,0); lcd.print("Analysing Pattern");     
                      delay(100);
                      ...
                      Serial.print("UV "); Serial.print(UV_PWM); Serial.print(","); Serial.print(" Wt "); Serial.print(BL_PWM); Serial.print(","); Serial.print(" R,G,B "); Serial.print(R_PWM); Serial.print(","); Serial.print(G_PWM); Serial.print(","); Serial.println(B_PWM);
                      ...
                      lcd.clear();
                      lcd.setCursor(0,0); lcd.print("Avg.: "); lcd.print(L_Prom_B); lcd.print(" lx");
                                                 ...
                                                 if (but1 != 0) {
                                                    if (Comp_t == 0) {
                                                      ...
                                                      lcd.setCursor(0,1); lcd.print("N:"); lcd.print(N_Prom_B); lcd.print(" R:"); lcd.print(R_Prom_B);
                                                        ...
                                                        if (Comp_t == 1) {
                                                              lcd.clear();
                                                              lcd.setCursor(0,0); lcd.print("Analyzing sample...");     
                                                              delay(100);
                                                              analogWrite(UV, UV_PWM);
                                                              analogWrite(BL, BL_PWM);
                                                              RGB_color(R_PWM, G_PWM, B_PWM);
                                                              ...
                                                              Serial.print("L,N,R,G,B "); Serial.print(L_Prom); Serial.print(","); Serial.print(N_Prom); Serial.print(","); Serial.print(R_Prom); Serial.print(","); Serial.print(G_Prom);Serial.print(","); Serial.println(B_Prom);
                                                              lcd.clear();
                                                              lcd.setCursor(0,0); lcd.print("Abs. Dif.: "); lcd.print(L_Prom); lcd.print(" lx");
                                                              lcd.setCursor(0,1); lcd.print("N:"); lcd.print(N_Prom); lcd.print(" R:"); lcd.print(R_Prom);
                                                              Comp_t = 2;                                                      
                                                              }
                                                                    if (Comp_t == 2) {
            ...
            lcd.clear();
            lcd.setCursor(0,0); lcd.print("Enter sample");       
            lcd.setCursor(0,1); lcd.print("Press 2nd btn");
                for (byte i = 0; i < 2; i++)
                 {
                  int but0 = digitalRead(buttons[0]);
        ...
        case 5:
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Value (R,G,B)");
        ...
        case 6:
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Value UV (0-255)");
       ...
       case 7:
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Value Wt (0-255)");
        ...
        case 12:
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Set delay (ms)");
        ...
        case 13:
          lcd.clear();
          lcd.setCursor(0,0); lcd.print("Set n");  lcd.print((char)223) ; lcd.print(" times");
        ...
        case 17:
          ...
          case 19:
                    pressedButton =0;
                    lcd.clear();
                    Serial.println("Complete RGBUV (L,N,R,G,B)");
                    lcd.setCursor(0,0); lcd.print("Complete RGBUV");
                    lcd.setCursor(0,1); lcd.print("Analyzing...");      
                      C_delay = 20;
                      C_times = 100;
                      L_delay = 100;
                      L_times = 5;
                      ...
                      BL_B_Prom = Color_B();
                      BL_L_Prom = Lux_P();               
                      Serial.print("Wt: "); Serial.print(BL_L_Prom); Serial.print(","); Serial.print(BL_N_Prom); Serial.print(","); Serial.print(BL_R_Prom);Serial.print(","); Serial.print(BL_G_Prom);Serial.print(","); Serial.println(BL_B_Prom);
                      analogWrite(BL, 0);
